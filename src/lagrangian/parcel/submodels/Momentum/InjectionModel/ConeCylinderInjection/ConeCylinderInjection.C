...
void Foam::ConeCylinderInjection<CloudType>::setInjectionMethod()
{
...
template<class CloudType>
void Foam::ConeCylinderInjection<CloudType>::setFlowType()
{
    const word flowType =
        this->coeffDict().template lookupOrDefault<word>
        (
...
template<class CloudType>
Foam::ConeCylinderInjection<CloudType>::ConeCylinderInjection
(
...
Foam::ConeCylinderInjection<CloudType>::ConeCylinderInjection
(
    const ConeCylinderInjection<CloudType>& im
)
:
...
template<class CloudType>
Foam::scalar Foam::ConeCylinderInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::ConeCylinderInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::ConeCylinderInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::ConeCylinderInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar time,
    ...
    switch (injectionMethod_)
    {
        ...
        case imCylinder:
        {
            ...
            (
                ...
                + frac_x * dr * t1
                + frac_y * dr * t2
                + (frac_z * hCylinder_ + offsetCylinder_) * n
            );
            this->findCellAtPosition
            (
                cellOwner,
...
template<class CloudType>
void Foam::ConeCylinderInjection<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar time,
...
template<class CloudType>
bool Foam::ConeCylinderInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::ConeCylinderInjection<CloudType>::validInjection(const label)
{
    return true;
}
